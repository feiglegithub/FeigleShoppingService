...
public class GetDefAddressServerlet extends HttpServlet {

	/**
		 * Constructor of the object.
		 */
	public GetDefAddressServerlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			AddressBean addressBean = AddressSqlUtils.getDefAddressList(name);
			
			JSONObject response = JSONObject.fromObject(addressBean);
