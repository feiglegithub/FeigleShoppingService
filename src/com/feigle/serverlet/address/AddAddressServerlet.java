...
public class AddAddressServerlet extends HttpServlet {

	/**
		 * Constructor of the object.
		 */
	public AddAddressServerlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			if(!AddressSqlUtils.isExist(name, contact, phone, address)) {
				boolean flag = AddressSqlUtils.add(name, contact, phone, address, def);
				if(flag)
					resp.getWriter().print("新增成功");
				else
					resp.getWriter().print("新增失败");
			}else
				resp.getWriter().print("该地址已经存在");
