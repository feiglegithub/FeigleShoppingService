...
public class DeleteShoppingServerlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public DeleteShoppingServerlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (null != userName && !("").equals(userName)) {
			...
			boolean flag = ShoppingSqlUtils.delete(id);
			if (flag)
			...
			resp.getWriter().print("ÄãÎ´µÇÂ½»òÕßµÇÂ½¹ýÆÚ£¡");
		}
	}
