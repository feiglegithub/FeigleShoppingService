...
public class GetTransportByEnableServerlet extends HttpServlet {

	/**
		 * Constructor of the object.
		 */
	public GetTransportByEnableServerlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		TransportBean transportBean = TransportSqlUtils.getEnableTransport();
