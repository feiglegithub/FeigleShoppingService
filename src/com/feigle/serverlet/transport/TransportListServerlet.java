...
public class TransportListServerlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public TransportListServerlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(null != userName && !("").equals(userName)) {
			if(UserSqlUtils.isBackstageStaff(userName)) {
				List transportList = TransportSqlUtils.getTransportList();
				req.setAttribute("transportList", transportList);
				req.getRequestDispatcher("/transport.jsp").forward(req, resp);
			}else
