...
public class UpdatePswServerlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public UpdatePswServerlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			String psw = jsonObject.getString("old");
			String newPsw = jsonObject.getString("newPsw");

			if (!UserSqlUtils.userVerifyForAPP(name, psw)) {
				resp.getWriter().print("旧密码不正确！");
			} else {
				boolean flag = UserSqlUtils.updatePsw(name, newPsw);
				if (flag)
