...
(function(exports) {
    ...
    exports.appendTestData = function(dom, count, isReset, index) {
        ...
        var template = '<div class="list-item"><div class="row"><div class="col-xs-4"><img src="../img/loading2.png" width="100%" height="100%" alt=""/></div><div class="col-xs-4"><p>{{commodity}}</p><p>{{inventory}}</p><p>{{price}}</p></div><div class="col-xs-4"><input type="button" value="加入购物车"><br><input type="button" value="立即购买"></div></div></div>';
